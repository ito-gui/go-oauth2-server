...
[5]: http://ito-gui.com/images/btcaddress.png
...
[![Travis Status for ito-gui/go-oauth2-server](https://travis-ci.org/ito-gui/go-oauth2-server.svg?branch=master&label=linux+build)](https://travis-ci.org/ito-gui/go-oauth2-server)
[![godoc for ito-gui/go-oauth2-server](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/ito-gui/go-oauth2-server)
[![codecov for ito-gui/go-oauth2-server](https://codecov.io/gh/ito-gui/go-oauth2-server/branch/master/graph/badge.svg)](https://codecov.io/gh/ito-gui/go-oauth2-server)

[![Sourcegraph for ito-gui/go-oauth2-server](https://sourcegraph.com/github.com/ito-gui/go-oauth2-server/-/badge.svg)](https://sourcegraph.com/github.com/ito-gui/go-oauth2-server?badge)
[![Donate Bitcoin](https://img.shields.io/badge/donate-bitcoin-orange.svg)](https://ito-gui.github.io/donate/)
...
This server is easily extended or modified through the use of plugins. Four services, [health](https://github.com/ito-gui/go-oauth2-server/tree/master/health), [oauth](https://github.com/ito-gui/go-oauth2-server/tree/master/oauth), [session](https://github.com/ito-gui/go-oauth2-server/tree/master/session) and [web](https://github.com/ito-gui/go-oauth2-server/tree/master/web) are available for modification.
